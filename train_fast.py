...
def main():
    ...
    print(f"Dataset: {config['num_train_instances']} train instances × {config['duration']}s")
    ...
    print(f"Generalization ratio: {best_test_loss / history['train_loss'][best_epoch-1]:.4f}")
    print("=" * 70)
