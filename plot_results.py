...
def plot_signal_reconstruction(
    ...
    for i, freq in enumerate(frequencies):
        ...
        axes[i+1].plot(t, target_components[i, :num_samples_to_show], 
                      'b-', label='Target', linewidth=2, alpha=0.7)
        axes[i+1].plot(t, predicted_components[i, :num_samples_to_show], 
                      'r--', label='Predicted', linewidth=2, alpha=0.7)
        
        axes[i+1].set_title(f'{freq} Hz Component (MSE: {mse:.6f})', 
...
def plot_per_frequency_metrics(
    ...
    bars1 = ax.bar(x - width/2, train_mse, width, label='Training', 
                   color='skyblue', edgecolor='black', linewidth=1.5)
    bars2 = ax.bar(x + width/2, test_mse, width, label='Test', 
...
def plot_error_distribution(
    ...
    for i, freq in enumerate(frequencies):
        ...
        axes[i].set_title(f'{freq} Hz - Error Distribution\n'
...
def plot_error_over_time(
    ...
    for i, freq in enumerate(frequencies):
        ...
        axes[i].set_title(f'{freq} Hz - Error Over Time', fontsize=11, fontweight='bold')
